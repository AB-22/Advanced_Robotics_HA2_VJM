...
if leg=='x'
    ...
    *Rx(q(3)) * Ty(l_2) * Tx(t(8)) * Ty(t(9)) * Tz(t(10)) * Rx(t(11)) * Ry(t(12)) * Rz(t(13)) * Rx(q(4))*Ty(l_platform) * T_tool;
end

if leg=='y'
    T = T_base * Ty(q(1)) * Ty(t(1)) * Ry(q(2)) * Tz(l_1) * Tx(t(2)) * Ty(t(3)) * Tz(t(4)) * Rx(t(5)) * Ry(t(6)) * Rz(t(7)) ...
    *Ry(q(3)) * Tz((l_2)) * Tx(t(8)) * Ty(t(9)) * Tz(t(10)) * Rx(t(11)) * Ry(t(12)) * Rz(t(13)) * Ry(q(4))*Tz(l_platform) *T_tool;
end
